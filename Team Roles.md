...
If you want, I’ll now convert each person’s assignment into a *GitHub issue template* (title, description, checklist, estimate) ready to paste into your repo. Which person should I generate the first issue for?